...
st.caption("💾 Auto-saved • Your grocery joy is safe now ❤️")import streamlit as st
import pandas as pd
from datetime import date
import os
...
# Nice footer
st.caption("Made with ❤️ by ROSE using Streamlit • 💾 Auto-saved • Your grocery joy is safe now ❤️")
